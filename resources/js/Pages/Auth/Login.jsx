    ...
    return (
        <GuestLayout>
            ...
            <form onSubmit={submit} className="space-y-5">
                ...
                <PrimaryButton
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-violet-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-200 transition hover:bg-violet-700"
                    disabled={processing}
                >
